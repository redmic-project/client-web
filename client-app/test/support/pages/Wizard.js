define([
	...
	, 'test/support/pages/steps/DoubleListFiltered'
	, 'test/support/pages/steps/DoubleList'
	, 'test/support/pages/steps/Form'
	, 'test/support/pages/steps/FormList'
	, 'test/support/pages/steps/LayerImage'
	, 'test/support/pages/steps/LineGeometry'
	, 'test/support/pages/steps/List'
	, 'test/support/pages/steps/RelationData'
	, 'test/support/pages/steps/ReorderLayerList'
	, 'test/support/pages/steps/PointGeometry'
	, 'test/support/Utils'
], function (
	declare
	, lang
