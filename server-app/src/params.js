...
module.exports = function(version) {
	...
	program
		...
		.option('-l, --default-lang <value>', 'Set language used by default when none is specified at requests',
			process.env.DEFAULT_LANG || 'es')
		.option('-p, --port <n>', 'Set network port used to expose app', parseInt(process.env.PORT, 10) || 3050)
